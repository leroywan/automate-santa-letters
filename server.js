...
So there has been a rumour going on around town that Santa Claus will give you a lump of coal for Christmas if you have been naughty throughout the year. I do not know how the rumour started spreading, but it is actually true!\n
I have been looking at my list and checking it twice and I noticed that your name was nowhere to be found, which means that you were not naughty enough to be on the naughty list, but not nice enough to be included in the nice list either. If you start behaving nicer such as ${lineItems["Good Deed"]}, your name might just pop up in the Nice List. However, if you do something naughty in the upcoming weeks such as ${lineItems["Naughty Deed"]}, you may have to receive a piece of coal this Christmas! I look forward to delivering you a present this year and I will be keeping a close eye on you ${lineItems["First Name"]}! Until then, continue being good, enjoy your time with your family, and have a Merry Merry Christmas!`;

  const familyHistory = `Dear ${lineItems["First Name"]},\n
Merry Christmas! I was looking at the nice list that I have made a long time ago and guess what? Both your parents were at the top of my nice list every year when they were children, your grandparents too! I wonder if you would be able to keep this streak going for your family because it really is an incredible family achievement!\n
People usually see Christmas as a holiday to receive presents and play, but Christmas is also a holiday to spend time with your family - and you are blessed with a wonderful, loving, family. ${lineItems["First Name"]}, I am very proud of you this year, especially when you ${lineItems["Good Deed"]}. I can’t wait until I visit your home in ${lineItems["Location"]} on Christmas Eve to deliver you your present. I have to go now but until then, continue setting an amazing example to others and enjoy this lovely Christmas spirit with your family! Ho Ho Ho!`;

  const theVisit = `Dear ${lineItems["First Name"]},\n
Ho Ho Ho, it's Christmas time again! I am very proud to tell you that you have made it to my nice list for being so good this year. The elves at the workshop have already finished wrapping all the presents and I will be visiting your home in ${lineItems["Location"]} on Christmas Eve to deliver them to you. I know you are just as excited about Christmas as I am but remember to sleep early or else I can’t deliver the presents!\n
Rudolph and the rest of the reindeer love seeing the ${lineItems["Nearby Landmark"]} every time we fly over your area. They also love eating the carrots bits that people seem to leave near the grass close to where we land. As for me, I love chocolate chip cookies which usually go really well with a nice glass of milk. Speaking of food, I heard that you are going to have ${lineItems["Christmas Dinner Item"]} for dinner this Christmas, how delicious! I have to go now because all this talk about food is making me very hungry and it is time for dinner here at the North Pole. I am very proud of you this year and I can’t wait to visit and bring you your present! Have a very Merry Christmas!`;

  const gettingOlder = `Dear ${lineItems["First Name"]},\n
Merry Christmas from the North Pole! I cannot wait until Christmas Eve when I come to visit your home in ${lineItems["Location"]} to see all the beautiful decorations that you have put up. It is starting to get really snowy here in the North Pole and the elves have been building a giant snowman around my workshop – it is almost as tall as the workshop itself!\n
Oh, and before I forget, I just want to congratulate you for making this year’s official nice list! I have already checked twice and there is no doubt that you have been an amazing child this year. I remembered seeing your name beside ${lineItems["Friend or Family"]}'s name on my list last Christmas and I can’t believe you are already ${lineItems["Age"]} years old now. You have grown up so much and I am super proud of you for setting such a great example again. Keep up the good work and don’t forget to go to bed early on Christmas Eve!`;
...
I have been waiting to write a letter to you ever since the moment I heard you were born. My name is Santa Claus and I travel from the North Pole every year during Christmas time with my reindeer to bring presents to children who have been good throughout the year. I have a list of every child's name in the world and I check that list twice to make sure that presents only get delivered to good children. If you have been naughty, be wary because you may just get a lump of coal for Christmas instead!\n
You are still so tiny, but you have already accomplished so much this year and I am super proud of you for that. As you get older and wiser, you will start to understand the true meaning of Christmas and it will be even more magical than you could have ever imagined. I will be watching you on your journey growing up and I hope to see your name on my nice list next year and every year after that. I know that you will be sound asleep, but I cannot wait until I visit you on Christmas Eve to deliver you your present. Have a very merry Christmas.\n
Santa`

  const elfOnTheShelf = `Dear ${lineItems["Name(s)"]},\n
I am extremely delighted to introduce you to this magical elf named ${lineItems["Elf Name"]} this Christmas. Every day between now and Christmas Eve, ${lineItems["Elf Name"]} will be at the house seeing if you have been naughty or nice. ${lineItems["Elf Name"]} is one of the best at the job and will be reporting to me every night about all observations made at the house. Each morning, your elf may decide to move to a new location since being in the same spot for too long gets a bit tiring. You may speak with ${lineItems["Elf Name"]} during the day but there is one rule that you have to follow very strictly: you cannot touch ${lineItems["Elf Name"]}. If you do, the elf’s power will be lost and won’t be able to return to the North Pole!\n
